...
face_cascade = cv2.CascadeClassifier('D:\\Eye_ball_cursor\\haarcascade_frontalface_default.xml')

eye_cascade = cv2.CascadeClassifier('D:\\Eye_ball_cursor\\haarcascade_eye.xml')
