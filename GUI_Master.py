...
root.title("EYE BALL CURSOR USING FACE DETECTION")

# 43

# ++++++++++++++++++++++++++++++++++++++++++++
#####For background Image
image2 = Image.open('121.jpg')
...
#
label_l1 = tk.Label(root, text="EYE BALL CURSOR USING FACE DETECTION",font=("Times New Roman", 35, 'bold'),
...
button1 = tk.Button(root, text="Face Recognisation", command=face_recognisation, width=14, height=1,font=('times', 20, ' bold '), bg="#152238", fg="white")
button1.place(x=100, y=160)

button2 = tk.Button(root, text="Face As A Mouse",command=Mouse_events,width=14, height=1,font=('times', 20, ' bold '), bg="#152238", fg="white")
